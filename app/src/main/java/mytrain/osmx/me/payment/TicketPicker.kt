...
class TicketPicker : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arrayAdapter_degree.setDropDownViewResource(R.layout.spinner_item);
        ...
        val arrayAdapter_time =
            ArrayAdapter(this, R.layout.spinner_item, travel_time)
        s_travel_time.adapter = arrayAdapter_time
        arrayAdapter_time.setDropDownViewResource(R.layout.spinner_item);
